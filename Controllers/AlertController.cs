...
namespace TradingAlertAPI.Controllers
{
    ...
    public class AlertController : ControllerBase
    {
        ...
        {
            // Get Eastern Time for file save and call API with this time
            ...
            String easternTime = TimeZoneInfo.ConvertTimeFromUtc(timeUtc, easternZone).ToString(CultureInfo.InvariantCulture);
            ...
            try
            {
                ...
                new AlertService().CallExternalAPI(easternTime, reqBody);
            }
